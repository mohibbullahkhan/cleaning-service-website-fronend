            ...
            <div className="relative z-[20] w-full mt-[32px] flex flex-col items-center">
                ...
                <div className="grid gap-4 w-full max-w-[900px] px-4">
                    <div className="grid gap-3 lg:grid-cols-[1.15fr_1fr_0.95fr] justify-center">
                        <div className="h-[60px] rounded-[24px] border border-white/30 bg-white/20 shadow-[0_24px_60px_rgba(0,0,0,0.08)] backdrop-blur-[16px] px-2 py-2 flex items-center justify-between animate-slide-in-left" style={{ animationDelay: '700ms' }}>
                        ...
                        <div className="h-[60px] rounded-[24px] border border-white/30 bg-white/20 shadow-[0_24px_60px_rgba(0,0,0,0.08)] backdrop-blur-[16px] px-2 py-2 flex items-center justify-between animate-slide-in-left" style={{ animationDelay: '850ms' }}>
                            <div className="flex items-center gap-3">
                                <span className="w-[28px] h-[28px] rounded-full border border-[#ddd] flex items-center justify-center text-[13px] text-[#888]">
                                    ⊙
                                </span>
                        ...
                        <div className="h-[60px] rounded-[24px] border border-white/30 bg-white/20 shadow-[0_24px_60px_rgba(0,0,0,0.08)] backdrop-blur-[16px] px-2 py-2 flex items-center justify-between animate-slide-in-left" style={{ animationDelay: '1000ms' }}>
                            <div className="flex items-center gap-3">
                                <span className="w-[28px] h-[28px] rounded-full border border-[#ddd] flex items-center justify-center text-[13px] text-[#888]">
                                    ▦
                                </span>
                    ...
                    <div className="grid gap-4 lg:grid-cols-[1.4fr_0.95fr] mt-0.5 pb-8">
                        <div className="grid gap-4 lg:grid-cols-2">
                            ...
                            <div className="rounded-[32px] border border-white/30 bg-white/20 shadow-[0_20px_70px_rgba(0,0,0,0.08)] backdrop-blur-[18px] overflow-hidden max-w-[340px] p-3 max-h-[380px] animate-slide-in-left" style={{ animationDelay: '1200ms' }}>
                                <p className="text-[10px] uppercase font-semibold text-black mb-2">
                                    Jenangan Ponorogo
                                </p>
                                ...
                                <img
                                    ...
                                    className="w-full h-[300px] object-cover rounded-[22px]"
                                />
                            </div>
                            <div className="rounded-[32px] border border-white/30 bg-white/20 shadow-[0_20px_70px_rgba(0,0,0,0.08)] backdrop-blur-[18px] overflow-hidden max-w-[340px] p-3  max-h-[380px] animate-slide-in-left" style={{ animationDelay: '1350ms' }}>
                                <p className="text-[11px] uppercase tracking-[0.28em] text-black mb-2">
                                    Cleaning Team
                                </p>
                        ...
                        <div className="grid gap-4">
                            <div className="rounded-[28px] border border-white/30 bg-white/20 shadow-[0_20px_70px_rgba(0,0,0,0.10)] backdrop-blur-[16px] max-w-[340px] p-4 animate-slide-in-left" style={{ animationDelay: '1500ms' }}>
                            ...
                            <div className="rounded-[28px] border border-white/30 bg-white/20 shadow-[0_20px_70px_rgba(0,0,0,0.10)] backdrop-blur-[16px] max-w-[340px] p-4 animate-slide-in-left" style={{ animationDelay: '1650ms' }}>
                                <p className="text-[14px] font-medium text-black mb-6">
                                    Total cost
                                </p>
